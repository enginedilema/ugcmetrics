    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                    ...
                    <flux:navlist.item icon="sparkles" :href="route('reddit.index')" :current="request()->routeIs('reddit.index')">{{ __('Reddit') }}</flux:navlist.item>
                    <flux:navlist.item icon="sparkles" :href="route('twitch.index')" :current="request()->routeIs('twitch.*')">{{ __('Twitch') }}</flux:navlist.item>
            ...
            @else
                ...
                <flux:menu class="w-[220px]">
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('login')" icon="user" wire:navigate>{{ __('Login') }}</flux:menu.item>
