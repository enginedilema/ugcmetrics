                ...
                <div
                    ...
                    <div class="flex flex-col items-center text-center mb-4">
                        ...
                        <img src="{{ $profile->profile_picture }}"
                            class="w-32 h-32 rounded-full object-cover border-4 border-purple-500 mb-4 hover:scale-105 transition-transform"
                        ...
                        @else
                        <div
                            class="w-32 h-32 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center border-4 border-purple-500 mb-4">
                            <span
                                class="text-4xl text-purple-600 dark:text-purple-400">{{ substr($profile->username, 0, 1) }}</span>
                        </div>
                        @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center text-center">
                            ...
                            @if(isset($latestMetrics) && isset($profile->twitchMetrics) &&
                            $profile->twitchMetrics->count() > 1)
                            @php
                            $previousMetrics = $profile->twitchMetrics->skip(1)->first();
                            $followerChange = $latestMetrics->followers - $previousMetrics->followers;
                            $changePercentage = $previousMetrics->followers > 0 ? ($followerChange /
                            $previousMetrics->followers) * 100 : 0;
                            @endphp
                            <p
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-3xl font-bold text-blue-600 dark:text-blue-400">
                                {{ number_format($profile->extra_data['view_count'] ?? 0) }}</p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div
                            ...
                            <h4 class="font-medium text-lg dark:text-white">{{ $report->getMonthNameAttribute() }}
                                {{ $report->year }}</h4>
                            <div class="grid grid-cols-2 gap-2 mt-3">
                                <div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Seguidores</p>
                                    <p class="font-medium dark:text-white">{{ number_format($report->followers_end) }}
                                    </p>
                                    <p
                                ...
                                <div>
                                    ...
                                    <p class="font-medium dark:text-white">{{ number_format($report->average_viewers) }}
                                    </p>
                                </div>
                            </div>
                        </div>
