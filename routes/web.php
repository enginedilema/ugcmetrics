...
//rutas para Reddit
Route::get('reddit', [App\Http\Controllers\RedditController::class, 'index'])->name('reddit.index');
Route::get('reddit/{username}', [App\Http\Controllers\RedditController::class, 'show']) -> name('reddit.show');